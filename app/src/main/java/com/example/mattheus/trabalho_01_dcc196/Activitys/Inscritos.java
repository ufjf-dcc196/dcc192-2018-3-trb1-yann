...
public class Inscritos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvParticipantesEvento = findViewById(R.id.rclv_listar_participantes);
        ...
        adapter = new ListarParticipantesAdapter(Singleton.getInstance().getParticipantes().get(posicaoParticipante).getEventos().get(posicaoEvento).getParticipantes());
