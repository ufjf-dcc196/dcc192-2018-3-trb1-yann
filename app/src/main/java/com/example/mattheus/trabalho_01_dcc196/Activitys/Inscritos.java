...
public class Inscritos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int posicaoEvento = bundleResult.getInt(EditarParticipante.POSICAO_EVENTO);
        int posicaoParticipante = bundleResult.getInt(EditarParticipante.POSICAO_PARTICIPANTE);
